    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip"><strong>My CV</strong></a>
              <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-bar bar1"></span><span class="navbar-toggler-bar bar2"></span><span class="navbar-toggler-bar bar3"></span></button>
            </div>
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#about"><strong>About</strong></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#skill"><strong>Skills</strong></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#portfolio"><strong>Portfolio</strong></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#experience"><strong>Experience</strong></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#contact"><strong>Contact</strong></a></li>
              </ul>
            </div>
          </div>
        </nav>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/picture.jpg');"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/picture1.jpg" alt="Image"/></a></div>
          <div class="h2 title">Patrick Aganz</div>
          <p class="category text-white"><strong>Web Developer, Android Developer,  Software Engineer</strong></p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="https://github.com/chevaine" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">My GitHub</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
          <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.linkedin.com/in/patrick-aganze-a4995b158/" target="_blank" rel="tooltip" title="Follow me on Linkedin"><i class="fa fa-linkedin-square"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="https://twitter.com/Patrickaganze2" target="_blank" rel="tooltip" title="Follow me on Twitter"><i class="fa fa-twitter"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="#" rel="tooltip" title="Follow me on Google+"><i class="fa fa-google-plus"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="#" rel="tooltip" title="Follow me on Instagram"><i class="fa fa-instagram"></i></a></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am Patrick Aganz. i'm passionate about Technology, i'm a full-stack Web Developer, Android Developer and a Software Engineer.</p>
            <p>I am confident that skills I have obtained through jobs experience and training would make a valuable contribution to your working environment. I interact well other especially in individuals / team environment work. I possess an excellent ability to listen clearly, contribute positively and encourage teamwork in others. I am a quick learner and look forward to working on an environment where I can contribute my skills and knowledge. <a href="https://templateflip.com/templates/creative-cv/" target="_blank">Learn More About Myself</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">patpelican007@gmail.com, aganze.it@aidesong.org</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+254 759009024</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">140, City kigali , Rwanda</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">English, French, Swahili</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">php</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 85%;"></div><span class="progress-value">85ø%</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Front-End Engineer</div>
            <p>Front-End Developer at DevPlug ltd Rwanda and in Kigali Independent University ICT Club</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png');">
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center"><strong>Patrick Aganz</strong></div>
      <div class="text-center text-muted">
        <p>&copy; All rights reserved.<br>Design - <a class="credit" href="https://github.com/chevaine" target="_blank">Patrick Aganz</a></p>
      </div>
    </footer>
